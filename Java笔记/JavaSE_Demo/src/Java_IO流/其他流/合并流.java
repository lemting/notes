...
public class 合并流
{
	...
	{
		InputStream fis1 = new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\其他流\\合并流.java");
		@SuppressWarnings("resource")
		InputStream fis2 = new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\其他流\\合并流.java");
		...
		InputStream fis3 = new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\其他流\\合并流.java");
		InputStream fis4 = new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\其他流\\合并流.java");
		InputStream fis5 = new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\其他流\\合并流.java");
		
		//public SequenceInputStream(Enumeration<? extends InputStream> e): 
		Vector<InputStream> v = new Vector<InputStream>(); 	//创建Vector<InputStream>集合对象
		v.add(fis3);v.add(fis4);v.add(fis5);	//添加InputStream输入流
