...
public class 通过反射获取类的构造方法并使用 {
	public static void main(String[] args) throws Exception {
		...
		// 返回一个包含Constructor对象的数组，反映由此Constructor对象表示的类的所有公共构造方法
		// 获取所有的构造方法
		...
		// 返回一个Constructor对象，该对象反映Constructor对象表示的类或接口的指定构造方法
		// 获取无参构造方法
		...
		// 用由此Constructor对象表示的构造函数，使用指定的初始化参数创建和初始化构造函数的声明类的新实例
		// 使用无参构造方法
