 ...
 *		public final void set(int year,int month,int date): 设置日历字段中的值YEAR ， MONTH 和 DAY_OF_MONTH
 *  
 *  Calendar 类的静态字段
 *  	YEAR(年), MONTH(月-1), DATE(日),  HOUR(时), MINUTE(分), SECOND(秒),
 *  	WEEK_OF_YEAR(年的第几周), WEEK_OF_MONTH(月的第几周)
 *		DAY_OF_YEAR(年的第几天), DAY_OF_MONTH(月的第几天), DAY_OF_WEEK(1-7: 周日-周六)
 *
