 ...
 *		十进制到其他进制:public static String toString(int i,int radix=10): 转换范围: 二进制到三十六进制
 *		其他进制到十进制:public static int parseInt(String s,int radix=10)
 ...
 *		public static Integer valueOf(String s): 	Integer.valueOf(s);
 *		
 *	int转String
 ...
 *		public static Float valueOf(String s):		Float.valueOf(s); 
 *
 *---------------------------
 *	其他基本类型的包装类类似
 *---------------------------
...
public class IntegerDemo {
	public static void main(String[] args) {
		...
		//public static Integer valueOf(String s):返回 Integer对象,
		String s = "100";
