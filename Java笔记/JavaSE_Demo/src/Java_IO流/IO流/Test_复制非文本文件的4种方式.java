...
public class Test_复制非文本文件的4种方式
{
	public static void main(String[] args) throws IOException
	{
		...
		BufferedInputStream bis = new BufferedInputStream(new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\IO流\\Test_复制非文本文件的4种方式.java"));
