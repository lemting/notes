 ...
 *
 * 	 String replace(char old,char new):替换字符串中某个指定字符
 * 	 String replace(String old,String new):替换字符串中某个指定字符串
 * 	 String replaceAll(String regex,String replacement): 用给定的replacement替换此字符串所有匹配正则表达式的子字符串
 */
