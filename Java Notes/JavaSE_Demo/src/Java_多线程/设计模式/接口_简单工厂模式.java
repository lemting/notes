...
//动物抽象类
abstract class Animal_1{public abstract void eat();}
//具体狗类
class Dog_1 extends Animal_1{public void eat(){System.out.println("狗吃肉");}}
//具体猫类
class Cat_1 extends Animal_1{public void eat(){System.out.println("猫吃鱼");}}
...
class AnimalFactory
{
	...
	//对象的创建
	public static Dog_1 createDog(){return new Dog_1();}
	public static Cat_1 createCat(){return new Cat_1();}
