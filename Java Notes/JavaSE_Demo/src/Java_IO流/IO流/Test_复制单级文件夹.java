...
public class Test_复制单级文件夹
{
	public static void main(String[] args) throws IOException
	{
		...
		BufferedInputStream bis = new BufferedInputStream(new FileInputStream("D:\\Programming\\Java\\MyEclipse\\Workspaces\\MyEclipse 2017 CI\\Java_IO流\\src\\IO流\\Test_复制单级文件夹.java"));
